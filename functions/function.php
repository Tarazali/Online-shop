	...
	function getCatPro(){
		...
		if(isset($_GET['cat'])){
			...
			if($count_cats == 0){
				...
				echo "<h2 style = 'padding:20px;'>No products are found in this category!</h2>";
			}
	...
	function getBrandPro(){
		...
		if(isset($_GET['brand'])){
			...
			if($count_brands == 0){
				...
				echo "<h2 style = 'padding:20px'>No products are found associated to this brand!</h2>";
			}
	...
	function getPro(){
		...
		if(!isset($_GET['cat'])){
			...
			if(!isset($_GET['brand'])){
				...
				$get_pro = "select * from product order by RAND() LIMIT 0,9";
